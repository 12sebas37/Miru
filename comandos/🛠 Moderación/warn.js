    ...
    run: async (client, message, args, prefix) => {
        ...
        if (message.guild.me.roles.highest.position > usuario.roles.highest.position) {
            ...
            if (message.member.roles.highest.position > usuario.roles.highest.position) {
                ...
                return message.reply(`❌ **Tu Rol está por debajo del usuario que quieres alertar**`)
            }
        } else {
            return message.reply(`❌ **Mi Rol está por debajo del usuario que quieres alertar**`)
        }
