...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if (data_usuario.dinero < 500) return message.reply("❌ **No puedes robar al usuario ya que, tiene menos de \`500 Dolares\`**")
        ...
        return message.reply(`✅ **Has robado \`${cantidad} Dolares\` a \`${usuario.user.tag}\`**`)
    }
}
